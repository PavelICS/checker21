...
- ⚠ Убедитесь, что вы закоммители все файлы и можете, если что их восстановить. Данный режим находится в стадии тестирования, и в нём могут быть баги, которые могут подпортить ваш код.
...
- INVALID_HEADER: отсутсвует заголовок (checker21 сгенерирует в начале файла заголовок)
- EMPTY_LINE_FILE_START: пустые линии в начале файла буду удалены
- NO_ARGS_VOID: сам подстави void, если функция не принимает аргументы
...
- SPACE_REPLACE_TAB: замени пробелы на табы по всем правилам
- EMPTY_LINE_FUNCTION: лишние пустые строки будут удалены
- SPACE_AFTER_KW: не достающие пробелы после return и других ключевых слов добавим
